...
class Ratings(models.Model):
    ...
    coursewhole = models.DecimalField(decimal_places=4, null=True, max_digits=8, db_column='CourseWhole') # Field name made lowercase.
    coursecontent = models.DecimalField(decimal_places=4, null=True, max_digits=8, db_column='CourseContent', blank=True) # Field name made lowercase.
    instructoreffectiveness = models.DecimalField(decimal_places=4, null=True, max_digits=8, db_column='InstructorEffectiveness', blank=True) # Field name made lowercase.
    instructorcontribution = models.DecimalField(decimal_places=4, null=True, max_digits=8, db_column='InstructorContribution', blank=True) # Field name made lowercase.
    instructorinterest = models.DecimalField(decimal_places=4, null=True, max_digits=8, db_column='InstructorInterest', blank=True) # Field name made lowercase.
    amountlearned = models.DecimalField(decimal_places=4, null=True, max_digits=8, db_column='AmountLearned', blank=True) # Field name made lowercase.
    grading = models.DecimalField(decimal_places=4, null=True, max_digits=8, db_column='Grading', blank=True) # Field name made lowercase.
...
class Instances(models.Model):
    ...
    idcourse = models.ForeignKey(Courses, db_column='idCourses') # Field name made lowercase.
